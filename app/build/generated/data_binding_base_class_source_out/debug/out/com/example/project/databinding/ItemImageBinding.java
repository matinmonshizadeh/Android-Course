...
public final class ItemImageBinding implements ViewBinding {
  ...
  private ItemImageBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageImage) {
  ...
  public static ItemImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemImageBinding((ConstraintLayout) rootView, imageImage);
    }
